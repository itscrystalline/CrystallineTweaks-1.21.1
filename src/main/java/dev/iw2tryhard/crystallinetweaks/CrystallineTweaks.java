package dev.iw2tryhard.crystallinetweaks;
...
@Mod(CrystallineTweaks.MODID)
public class CrystallineTweaks {
  // Define mod id in a common place for everything to reference
  public static final String MODID = "crystallinetweaks";
  ...
  public CrystallineTweaks(IEventBus modEventBus, ModContainer modContainer) {
